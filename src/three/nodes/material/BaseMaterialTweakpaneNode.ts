...
/**
 * Base class for material nodes that need Tweakpane controls (e.g., for file pickers)
 * Combines BaseMaterialNode functionality with TweakpaneNode
 */
export abstract class BaseMaterialTweakpaneNode<
  TInputs extends string = string,
> extends TweakpaneNode<
  | TInputs
  | 'opacity'
  | 'transparent'
  | 'side'
