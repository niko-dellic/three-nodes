...
export class BufferAttributeNode extends BaseThreeNode<
  'array' | 'itemSize' | 'normalized',
  'attribute'
> {
  constructor(id: string) {
    super(id, 'BufferAttributeNode', 'Buffer Attribute');
  ...
  evaluate(_context: EvaluationContext): void {
    ...
    const attribute = new THREE.BufferAttribute(typedArray, itemSize, normalized);
